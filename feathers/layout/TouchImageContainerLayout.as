package feathers.layout
{
	...
	public class TouchImageContainerLayout extends EventDispatcher implements ILayout
	{
		public function TouchImageContainerLayout()
		{
			super();
		}
		...
		public function layout(items:Vector.<DisplayObject>, viewPortBounds:ViewPortBounds = null, result:LayoutBoundsResult = null):LayoutBoundsResult
		{
			...
			if(itemCount > 1)
			{
				throw new IllegalOperationError("TouchImageContainerLayout may not have more than one item.");
			}
			if(!result)
			{
